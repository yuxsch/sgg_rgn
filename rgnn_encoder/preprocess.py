...
def read_entity_from_id(filename='./data/VG-KB/entity2id.txt'):
	entity2id = {}
...
def read_relation_from_id(filename='./data/VG-KB/relation2id.txt'):
	relation2id = {}
	with open(filename, 'r') as f:
		for line in f:
			if len(line.strip().split()) > 1:
...
def build_data(path='./data/VG-KB/', is_unweigted=False, directed=True):
